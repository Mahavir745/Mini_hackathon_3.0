...
const InputField = () => {
  ...
  return (
    ...
    <form action="" className='flex flex-col gap-[20px] w-[503px] h-[320px] m-[24px]' onSubmit={(e)=>HandleInputField(e)}>
      ...
      <div className='flex w-[503px] h-[36px]'>
        <button className='bg-violet-400 hover:bg-violet-600 w-[100%] text-[14px] text-white rounded-md'>Request Consent</button>
      </div>
    </form>
    </div>
    </div>
